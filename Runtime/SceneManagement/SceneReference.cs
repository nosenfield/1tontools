...
public class SceneReference : ISerializationCallbackReceiver
{
    ...
    public string SceneName
    {
        get
        {
            string[] pathPieces = ScenePath.Split("/".ToCharArray());
            return pathPieces[pathPieces.Length - 1].Replace(".unity", "");
        }
    }

    public List<GameObject> SceneRootObjects;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUI.BeginProperty(position, GUIContent.none, property);
        {
            ...
            // {
                ...
                EditorGUI.PropertyField(position, persistentProp, new GUIContent("Persistent"));
